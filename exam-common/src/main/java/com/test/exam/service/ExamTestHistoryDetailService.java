...
public interface ExamTestHistoryDetailService {
    ...
    public Integer insertExamTestHistoryDetailList(List<ExamTestHistoryDetail> examTestHistoryDetails)
            throws Exception;

    public Integer updateExamTestHistoryDetail(ExamTestHistoryDetail examTestHistoryDetail) throws Exception;

    public Integer updateExamTestHistoryDetailList(List<ExamTestHistoryDetail> examTestHistoryDetails)
            throws Exception;

    public ExamTestHistoryDetail getExamTestHistoryDetail(ExamTestHistoryDetail examTestHistoryDetail)
            throws Exception;
